...
function getSavedBestScores() {
  ...
  if (localStorage.getItem("bestScores")) {
    // set best score array, make sure to parse data as local storage cna only save data in strings
    ...
    // to save in local storage must be in key value pair
...
function UpdateBestScore() {
  bestScoreArray.forEach((score, index) => {
    ...
    if (questionAmount == score.questions) {
      ...
      // Update if new score is less or replacing zero
